...
public class Version {
	public static final String appName = "Exelite"; //"WowDoge";
	public static final String currentVersion = "0.3.9.7";
	public static final String preferencesName = "org.exelite"; //org.wowdoge
	public static final String spvChainFileName = "execoins.exespvchain"; //dogecoins.dogespvchain
	public static final String checkpointsFileName = "/org/wowdoge/exelite.checkpoints"; //"/org/wowdoge/wowdoge.checkpoints"
	public static final String defaultWalletFileName = "execoins.exewallet"; //"dogecoins.dogewallet"
	public static final String walletFileExtension = "exewallet"; //"dogewallet";
	public static final String walletFileExtensionWithDot = ".exewallet"; //".dogewallet";
	public static final String walletFileDescription = "Exelite Wallet Files"; //"Wow DOGE Wallet Files";
	public static final String coinImagePath = "/org/wowdoge/exe.png"; //doge
	public static final String coinName = "EXE"; //"DOGE";
	public static final String coinNameWithSpace = "EXE "; //"DOGE ";
	public static final String coinNameLong = "Execoin";
	public static final String coinNameLongSmall = "execoin";
	public static final String appIconPath = "/org/wowdoge/icon.png"; //doge
	public static final String appAboutImagePath = "/org/wowdoge/icon.png"; //doge
	public static final String logFileName = "exelite.log"; //wowdoge.log
	public static final String logFileNamePattern = "/exelite.%d.log.gz"; //wowdoge
	public static final String appWebsite = "http://www.exelite.org";
	public static final String appWebsiteWithoutHTTP = "www.exelite.org";
	public static final String coinLibraryName = "ExecoinJ"; //"DogecoinJ";
	public static final String donationAddress = "ELiteWbMDwX95YZj5Jf5BkHS54qbH7wpXg";
	public static final String supportEmailAddress = "info@vertigowallet.org";
	public static final int intCurrentVersion = toIntVersion(currentVersion);
	public static List<Version> versions = null;
	protected static final String updateURL = "http://www.exelite.org/version.txt";
