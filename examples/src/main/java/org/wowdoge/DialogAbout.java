...
public class DialogAbout extends JDialog {
	...
	public DialogAbout() {
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			btnWwwwowdogeorg.addComponentListener(new ComponentAdapter() {
				...
				public void componentResized(ComponentEvent arg0) {
					...
					btnWwwwowdogeorg.setIcon(new ImageIcon (new ImageIcon(Wow.class.getResource(Version.appAboutImagePath)).getImage().getScaledInstance(min0, -1, Image.SCALE_SMOOTH)));
		...
		}
		{
			...
			{
				JLabel lblCopyrightWow = new JLabel("Copyright 2014 " + Version.appName + " Developers");
